...
## 🖼️ Telas 
**Abertura / Splash**  
![Abertura / Splash](imgs/primeiro.gif)

**Lista e Busca**  
![Lista e Busca](imgs/segundo.gif)

**Detalhes**  
![Detalhes](imgs/terceiro.gif)

**Filtro por Tipo**  
![Filtro por Tipo](imgs/quarto.gif)

**Filtro por Geração**  
![Filtro por Geração](imgs/quinto.gif)
